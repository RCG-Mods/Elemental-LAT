...
export const storeTerms: string[] = [
  ...
  "Las propiedades y los vehículos no otorgan ninguna ventaja IC, por lo que su pago debe realizarse con dinero IC (más detalles dentro del ticket sobre el rol).",
];
